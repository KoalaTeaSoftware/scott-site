<template>
  <div class="container" id="volunteer">
    ...
    <div class="row align-items-center">
      ...
      <div class="col">
        <p>Here are some of the immediate ways in which you can help. Doubtless, as we grow, many more roles will
          develop:
        </p>
    ...
    <p class="lead">To volunteer please <a href="/contact?subject=Please tell me about volunteering">make contact using
